...
async def test_ollama_response_times():
    ...
    test_prompts = [
        ...
        ("Moyen", "Raconte une aventure dans Fondcombe pour un enfant de 10 ans en 3 phrases."),
        ("Long", "Decris les Mines de la Moria de maniere detaillee et immersive pour enfants."),
    ]
    ...
    for test_name, prompt in test_prompts:
        ...
        for i in range(3):
            ...
            try:
                ...
                print(f"OK - {duration*1000:.0f} ms ({len(response['response'])} chars)")
        ...
        if times:
            ...
            print(f"  => Moyenne: {avg*1000:.0f} ms, Min: {min(times)*1000:.0f} ms, Max: {max(times)*1000:.0f} ms")
